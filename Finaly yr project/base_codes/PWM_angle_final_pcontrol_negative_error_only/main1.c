...
#include "main.h"
// MAIN FUNCTIONS
unsigned int temp=0,count=0, theta_current=150, theta_req=0;
...
void main(void)
{
  ...
  TRISB = 0xFF;
  TRISD = 0x00; 
  PORTD = 0x10;		//RD0 made low, so that output is high, line is high, and ds is reversed			
