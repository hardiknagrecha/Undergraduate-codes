...
unsigned char initial_message[9] = {'S','e','r','i','a','l',0x0A,0x0D}, cnt=0, cord[15]={0}, enter_cord[] = {"Enter co-ordinates as - XX.XX,YY.YY@ : "};
...
//---------------------------------------------------------------------------------------------------------------------------
  SendByteSerially(0x0A);
  SendByteSerially(0x0D);
  SendStringSerially(cord);		// REMOVE THIS WHEN DONE CHECKING THE CODE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
//---------------------------------------------------------------------------------------------------------------------------  
  ...
  xc = (10*cord[0])+cord[1]+(0.1*cord[3])+(0.01*cord[4]);
  yc = (10*cord[6])+cord[7]+(0.1*cord[9])+(0.01*cord[10]);
