	...
	; Compiler options:
	;
	; -onew led project.cof -mnew led project.map \
	; --summary=default,-psect,-class,+mem,-hex --output=default,-inhx032 \
	; led.p1 delay.p1 LCD.p1 --callgraph=full --chip=16F877 -P \
	; --runtime=default,+clear,+init,+keep,+osccal,-download,-resetbits,+stackcall,+stackwarn,+clib \
	; --opt=default,+asm,9 --warn=0 --rom=default,-0000-03ff --double=24 \
