	...
	; Compiler options:
	;
	; -odisplay.cof -mdisplay.map --summary=default --output=default \
	; delay.p1 main.p1 --chip=16F877A -P --runtime=default --opt=default \
...
;	9 bytes of RAM objects in common bank to zero
	...
	movwf	FSR
	movlw	low(__Lcommon+9)		;load the high address+1 into W
